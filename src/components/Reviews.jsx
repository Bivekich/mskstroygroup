...
const TestimonialsSection = () => {
  ...
  return (
    <div className="bg-[#393939] text-white py-5 sm:py-8 md:py-10 relative">
      ...
      <div className="flex flex-col space-y-4 sm:space-y-6 md:space-y-8 w-[95%] sm:w-[85%] md:w-[80%] mx-auto">
        {/* Testimonial 1 */}
        {testimonials[0] && (
          <div className="bg-[#757575] p-4 sm:p-5 md:p-6 flex flex-col w-full lg:w-8/12 space-y-3 sm:space-y-4 pb-8 sm:pb-12 md:pb-20 duration-500 hover:scale-[1.01] hover:shadow-2xl transition-all">
            <img
              src={Quote}
              alt="Quote Icon"
        ...
        {/* Testimonial 2 */}
        {testimonials[0] && (
          <div className="bg-[#757575] lg:ml-[10%] p-4 sm:p-5 md:p-6 flex flex-col w-full lg:w-8/12 space-y-3 sm:space-y-4 pb-8 sm:pb-12 md:pb-20 duration-500 hover:scale-[1.01] hover:shadow-2xl transition-all">
            <img
              src={Quote}
              alt="Quote Icon"
              className="text-[#8BFF30] w-[40px] sm:w-[55px] md:w-[70px]"
        ...
        {/* Testimonial 3 */}
        {testimonials[0] && (
          <div className="bg-[#757575] lg:ml-[20%] p-4 sm:p-5 md:p-6 flex flex-col w-full lg:w-8/12 space-y-3 sm:space-y-4 pb-8 sm:pb-12 md:pb-20 duration-500 hover:scale-[1.01] hover:shadow-2xl transition-all">
            <img
              src={Quote}
              alt="Quote Icon"
              className="text-[#8BFF30] w-[40px] sm:w-[55px] md:w-[70px]"
        ...
        {/* Testimonial 4 */}
        {testimonials[0] && (
          <div className="bg-[#757575] lg:ml-[30%] p-4 sm:p-5 md:p-6 flex flex-col w-full lg:w-8/12 space-y-3 sm:space-y-4 pb-8 sm:pb-12 md:pb-20 duration-500 hover:scale-[1.01] hover:shadow-2xl transition-all">
            <img
              src={Quote}
              alt="Quote Icon"
              className="text-[#8BFF30] w-[40px] sm:w-[55px] md:w-[70px]"
